        ...
        <div class="anime-sync-converter-test" style="margin-top:20px;padding:20px;background:#fff;border:1px solid #ccd0d4;">
            ...
            <?php if ( class_exists( 'Anime_Sync_CN_Converter' ) ) : ?>
                ...
                <table class="wp-list-table widefat fixed">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ( ! empty( $stats['dict_file_size'] ) && $stats['dict_file_size'] > 0 ) : ?>
                                <span style="color:green;">✓ 檔案存在 (<?php echo size_format( $stats['dict_file_size'] ); ?>)</span>
                            <?php else : ?>
                    ...
                    <tr>
                        <th>詞條總數</th>
                        <td><?php echo esc_html( $stats['dict_entry_count'] ?? 0 ); ?> 條</td>
                    </tr>
                    <tr>
                        <th>轉換模式</th>
                        <td><?php echo esc_html( $stats['mode'] ?? 'dict' ); ?></td>
                    </tr>
                    <tr>
                        <th>轉換測試</th>
                        <td>
            ...
            <?php else : ?>
                <p style="color:red;">錯誤：找不到 Anime_Sync_CN_Converter 類別。</p>
            <?php endif; ?>
        </div>
